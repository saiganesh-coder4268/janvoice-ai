    ...
    <div className="w-full h-full overflow-y-auto bg-muted p-6 md:p-8">
      <div className="max-w-4xl mx-auto space-y-8">
        <div>
          ...
          <p className="text-muted-foreground mt-1">AI-generated summaries and development recommendations for Visakhapatnam.</p>
        </div>
        ...
        <div className="bg-card border border-border rounded-xl shadow-sm overflow-hidden">
          <div className="p-6 border-b border-border bg-muted/50 flex items-center gap-3">
            ...
            <h2 className="text-xl font-bold text-foreground">Active Recommendations</h2>
          </div>
          <div className="p-12 flex flex-col items-center justify-center text-center">
            <Lightbulb className="h-12 w-12 text-slate-300 mb-4" />
            <h3 className="text-lg font-semibold text-muted-foreground mb-2">No active recommendations</h3>
            <p className="text-muted-foreground max-w-md">Gemini is currently analyzing civic data across all wards. Check back later for clustered development recommendations.</p>
          </div>
        </div>
          ...
          <div className="p-6">
            {loading ? (
              ...
              <div className="text-center py-8">
                <p className="text-muted-foreground">No weekly summary generated yet.</p>
              </div>
            )}
          </div>
        </div>
