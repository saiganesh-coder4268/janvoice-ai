    ...
    <main className="min-h-screen bg-muted flex flex-col">
      ...
      <div className="flex-1 max-w-4xl w-full mx-auto p-4 md:p-8">
        <div className="flex items-center gap-3 mb-8">
          ...
          <div>
            <h1 className="text-2xl font-bold text-foreground tracking-tight">Civic Updates</h1>
            <p className="text-sm text-muted-foreground">Recently resolved issues and community updates</p>
          </div>
        </div>
        ...
        {isLoading ? (
              ...
              >
                <div className="p-5 sm:p-6 flex flex-col sm:flex-row gap-6">
                  ...
                  <div className="flex-1 flex flex-col justify-center">
                    ...
                    <div className="flex flex-wrap items-center gap-3 sm:gap-4 text-xs font-medium text-muted-foreground mb-4">
          ...
          <div className="bg-card rounded-xl border border-border border-dashed p-12 text-center">
            <div className="h-12 w-12 rounded-full bg-muted flex items-center justify-center text-slate-400 mx-auto mb-4">
              <CheckCircle2 className="h-6 w-6" />
            </div>
            <h3 className="text-lg font-medium text-foreground mb-1">No recent resolutions</h3>
            <p className="text-muted-foreground">There are no recently solved issues in your area.</p>
          </div>
        )}
      </div>
    </main>
