  ...
  return (
    <div className="flex flex-col min-h-screen bg-muted">
      ...
      <main className="flex-1">
        {/* Hero Section */}
        <section className="w-full py-24 md:py-32 lg:py-48 bg-card border-b border-border">
          <div className="container px-4 md:px-6 mx-auto text-center">
            <div className="flex flex-col items-center space-y-4">
              ...
              <div className="flex flex-col sm:flex-row gap-4 mt-8">
                <Link href="/citizen">
                  <Button size="lg" className="bg-blue-600 hover:bg-blue-700 text-primary-foreground w-full sm:w-auto">
                    Report an Issue
                  </Button>
                </Link>
                <Link href="/mp">
                ...
                <Link href="/map">
                  <Button size="lg" className="bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 text-primary-foreground w-full sm:w-auto shadow-md border-0 transition-all hover:scale-105 duration-200 flex items-center justify-center gap-2">
